= Vision: {project-name}
Kevin Kunze <s87006@htw-dresden.de>; Natalie Hinze s86218@htw-dresden.de; Loris Kulke s87072@htw-dresden.de; Luca Funk <email>; Ruben Czock s87149@htw-dresden.de; Lucas Effenberger s87202@htw-dresden.de; Ali s85161@htw-dresden.de
{localdatetime}
