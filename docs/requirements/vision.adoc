...
Dieses Visions-Dokument bezieht sich auf das System {project-system-name}, das von {project-system-name}-Team entwickelt wird. Das System wird es Studierenden erlauben, sich selbst finanziell zu planen, um damit unnötige Ausgaben zu reduzieren und selbst gesetzte Sparziel zu erreichen.
