...
=== Dev Team
* Loris – Product Owner, verantwortlich für das Sprint Backlog und KI-Anbindung sowie Datenbank
* Kevin – Frontend+Backend, Verbindung Frontend-Komponenten & Backend, Datenbankentwicklung
* Luca – Frontend, Entwicklung von Frontend-Komponenten
* Lukas – Backend, Entwicklung von Backend-Komponenten
* Ali – Frontend, Entwicklung von Frontend-Komponenten

=== Kommunikation
Folgende Channels wurden genutzt:

* Miro – Gesamtübersicht sämtlcher Informationen bezüglich des Projekts
* GitHub – Aufgabenverteilung und Tracking des Fortschritts
...
-Erstellung eines ausformulierten Tasks auf Basis der User Stories
